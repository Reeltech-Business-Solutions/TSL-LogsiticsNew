table 80023 "Billing Line"
{
    ...
    fields
    {
        ...
        field(8; "Avaialability Per TruckNo.Days"; Decimal)
        {
        ...
        field(14; "Residency Time at loadingpoint"; Time)
        {
        ...
        field(17; "ResidencyTime at ofloadinpoint"; Time)
        {
        ...
        {
            Caption = 'Available per truck No. of days';
            // AutoIncrement = true;
            DataClassification = ToBeClassified;
        }
        ...
        field(50015; "TMR No."; Code[50])
        {
            Caption = 'TMR Record No.';
            DataClassification = ToBeClassified;
        }
        field(50016; "Driver Allowance"; Decimal)
        {
            Caption = 'Driver Allowance';
            DataClassification = ToBeClassified;
        }
        field(50017; "Loading Date"; Date)
        {
            Caption = 'Loading Date';
            DataClassification = ToBeClassified;
        }
         field(50018; "Driver's No."; Code[20])
        {
            Caption = 'Driver No.';
            DataClassification = ToBeClassified;
        }
         field(50019; "Loading Point"; Code[20])
        {
            Caption = 'Loading Point';
            DataClassification = ToBeClassified;
        }
         field(50020; "Freight(rate) Naira"; Decimal)
        {
            Caption = 'Freight(rate) Naira';
            DataClassification = ToBeClassified;
        }
         field(50021; "Amount"; Decimal)
        {
         ...
         field(50022; "Diesel Quantity/Volume"; Decimal)
        {
            Caption = 'Diesel Quantity/Volume';
            DataClassification = ToBeClassified;
        }
         field(50023; "Diesel Rate"; Decimal)
        {
            Caption = 'Diesel Rate';
            DataClassification = ToBeClassified;
        }
         field(50024; "Freight(rate) USD"; Decimal)
        {
            Caption = 'Freight(rate) USD';
            DataClassification = ToBeClassified;
        }
        field(50025; "Overage"; Code[20])
        {
           Caption = 'Overage';
           DataClassification = ToBeClassified; 
        }
