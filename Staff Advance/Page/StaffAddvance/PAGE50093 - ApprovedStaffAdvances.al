page 50093 "Approved Staff Advances"
{

    Caption = 'Approved Staff Advances';
    ApplicationArea = All;
    ...
    SourceTableView = WHERE(Status = Const(Approved), Posted = CONST(false), "Type of Advance" = filter("Staff Advance"));
    UsageCategory = Lists;
