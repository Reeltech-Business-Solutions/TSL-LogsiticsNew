page 50052 "Apply Employee Entries2"
{
    ...
    var
        ...
        AdvanSurrender: Record "Staff Advan Surrender Details";
        EmployeeLedgerEntry: Record "Employee Ledger Entry";
        EmployLine: Record "Staff Advan Surrender Details";
        AdvanSurrenderHeader: Record "Staff Advanc Surrender Header";
    ...
    begin
        if (CalcType = CalcType::GenJnlLine) and (TempApplyingEmplLedgEntry."Posting Date" < Rec."Posting Date") then
            Error(
              EarlierPostingDateErr, TempApplyingEmplLedgEntry."Document Type", TempApplyingEmplLedgEntry."Document No.",
              Rec."Document Type", Rec."Document No.");
                    ...
                    case ApplnType of
                        ApplnType::"Applies-to Doc. No.":
                            begin
                                ...
                                if AppliedEmplLedgEntry."Currency Code" <> ApplnCurrencyCode then
                                    AppliedEmplLedgEntry."Remaining Amount" :=
                                      CurrExchRate.ExchangeAmtFCYToFCY(
                                        ApplnDate, AppliedEmplLedgEntry."Currency Code", ApplnCurrencyCode, AppliedEmplLedgEntry."Remaining Amount");

                                AppliedAmount := AppliedAmount + Round(AppliedEmplLedgEntry."Remaining Amount", AmountRoundingPrecision);
    ...
    begin
        CorrectionAmount := 0;
        if AppliedEmplLedgEntry.Find('-') then begin
            repeat
    ...
    procedure SetPVLine(NewAdvancSurrLine: Record "Staff Advan Surrender Details"; var NewEmployeeLedgEntry: Record "Employee Ledger Entry"; ApplnTypeSelect: Integer)
    var
