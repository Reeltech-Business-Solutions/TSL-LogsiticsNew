page 50185 "Posted Staff Ret. List"
{
    ApplicationArea = All;
    Caption = 'Posted Staff Advance Ret. List';
    CardPageID = "Staff Advance Retirement";
    Editable = false;
    PageType = List;
    SourceTable = "Staff Advanc Surrender Header";
    SourceTableView = WHERE(Posted = CONST(true), "Retirement Type" = filter("Advance Retirement"));
    UsageCategory = Lists;
    InsertAllowed = false;
