page 50073 "Staff Advance Surrender List"
{
    ApplicationArea = All;
    Caption = 'Staff Advance Ret. List';
    CardPageID = "Staff Advance Retirement";
    //Editable = false;
    PageType = List;
    SourceTable = "Staff Advanc Surrender Header";
    SourceTableView = WHERE(Posted = CONST(false), "Retirement Type" = filter("Advance Retirement"));
    UsageCategory = Lists;
    //InsertAllowed = true;
    ...
    actions
    {
        area(processing)
        {
            group(Functions)
            {
                ...
                action(ImportStaffRetire)
                {
                    Caption = 'ImportStaffRetire';
                    Image = Import;
                    ApplicationArea = All;
                    Promoted = true;
                    PromotedCategory = Process;
                ...
                action(ImportRetH)
                {
                    Caption = 'Import StaffRetire Header';
                    Image = Print;
                    Promoted = true;
                    PromotedCategory = Report;
                    PromotedIsBig = true;
                ...
                action(ImportRet)
                {
                    Caption = 'Import StaffRetire Lines';
                    Image = Print;
                    Promoted = true;
                    PromotedCategory = Report;
                    PromotedIsBig = true;
