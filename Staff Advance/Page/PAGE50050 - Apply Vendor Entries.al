page 50050 "Apply Vendor Entries2"
{
    ...
    begin
        case CalcType of
            ...
            CalcType::PV:
                begin
                    ApplyingVendLedgEntry."Posting Date" := PVLine."Posting Date";
                    ...
                    case ApplnType of
                        ApplnType::"Applies-to Doc. No.":
                            begin
                                ...
                                AppliedVendLedgEntry.CalcFields(AppliedVendLedgEntry."Remaining Amount");
            ...
            if ApplyingVendLedgEntry."Entry No." <> 0 then begin
                ...
                if ACTION::OK = PostApplication.RunModal then begin
                    ...
                    if NewApplicationDate < ApplicationDate then
                        Error(Text013, Rec.FieldCaption(Rec."Posting Date"), Rec.TableCaption);
                end else
                    Error(Text019);
    ...
    [Scope('Cloud')]
    procedure ExchangeAmountsOnLedgerEntry(Type: Option Direct,GenJnlLine,PurchHeader; CurrencyCode: Code[20]; var CalcVendLedgEntry: Record "Vendor Ledger Entry"; PostingDate: Date)
    var
    ...
    [IntegrationEvent(false, false)]
    local procedure OnAfterExchangeAmountsOnLedgerEntry(var CalcVendorLedgerEntry: Record "Vendor Ledger Entry"; VendorLedgerEntry: Record "Vendor Ledger Entry"; CurrencyCode: Code[20])
    begin
    end;

    [IntegrationEvent(true, false)]
    local procedure OnBeforeHandledChosenEntries(Type: Option Direct,GenJnlLine,PurchHeader; CurrentAmount: Decimal; CurrencyCode: Code[20]; PostingDate: Date; var AppliedVendLedgEntry: Record "Vendor Ledger Entry"; var IsHandled: Boolean)
    begin
    end;
    ...
    procedure SetPVLine2(NewPVLine: Record "Voucher Line"; var NewVendLedgEntry: Record "Vendor Ledger Entry"; ApplnTypeSelect: Integer)
    var
    ...
    procedure SetPVLine(NewPVLine: Record "Payments Line"; var NewVendLedgEntry: Record "Vendor Ledger Entry"; ApplnTypeSelect: Integer)
    var
