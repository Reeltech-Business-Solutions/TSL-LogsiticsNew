report 50032 "Truck Transaction PZCUSSSON"
{
    ApplicationArea = All;
    Caption = 'PZCUSSON  Processing2';
    DefaultLayout = RDLC;
    RDLCLayout = './Process Transaction PZCUSSON.rdl';
    UsageCategory = Lists;
    dataset
    {
                ...
                begin
                    ...
                    if BillingLineSum.FindFirst() then begin
                        repeat
                            ...
                            FixedPricePeLoca.SetCurrentKey(FixedPricePeLoca.Location, FixedPricePeLoca."Contract ID");
