table 50039 "Receipts Header"
{
    ...
    fields
    {
        ...
        field(9; "Received From"; Text[30])
        {
        }
        field(10; "On Behalf Of"; Text[50])
        {
        }
        ...
        {
            CalcFormula = Sum("Receipts Line"."Total Amount" WHERE("No." = FIELD("No.")));
            Editable = false;
        ...
        field(81; "Responsibility Center"; Code[20])
        {
        ...
        field(86; Dim3; Text[60])
        {
        }
        field(87; Dim4; Text[60])
        {
        }
        field(88; "Bank Name"; Text[50])
        {
        }
        ...
        field(481; "Function Name"; Code[30])
        {
            Description = 'Stores the name of the Staff MIS Code Description in the database';
        }
        field(482; "Budget Center Name"; Code[30])
        {
            Description = 'Stores the name of the Team Code Description in the database';
        }
        field(483; "Applies-to ID"; Code[20])
        {
    ...
    begin
        "Dimension Set ID" :=
          DimMgt2.EditDimensionSet("Dimension Set ID", StrSubstNo('%1 %2', 'Receipt', "No."));
        //VerifyItemLineDim;
    ...
    local procedure UpdateHeaderToLine()
    begin
    end;
}
