page 50209 "LC-Utility Advance Card"
{
    Caption = 'LC-Utility Advance Card';
    DeleteAllowed = false;
    PageType = Document;
    //PromotedActionCategories = 'New,Approval,Approvals';
    ShowFilter = false;
    SourceTable = "Staff Advance Header";
    SourceTableView = WHERE(Posted = CONST(false), "Type of Advance" = filter(LC));
    ...
    layout
    {
        area(content)
        {
            ...
            part("LC-Utility Advance Subform"; "LC-Utility Advance Subform")
            {
                Editable = editno;
                ApplicationArea = all;
            ...
            group(Approval)
            {
                        ...
                        if not Confirm('Are you sure you want to create a Payment Voucher for %1', false, Rec."No.") then
                            ...
                            if StaffAdvLines.Find('-') then begin
                                ...
                                repeat
                                    ...
                                    PaymentLines.Validate("Account Type", PaymentLines."Account Type"::Employee);
                ...
                action(PostAdvance)
                {
                    ...
                    begin
                        ...
                        GenJnlLine.Validate("Document No.", Rec."No.");
                        GenJnlLine."External Document No." := Rec."Cheque No.";
                        GenJnlLine.Validate("Account Type", GenJnlLine."Account Type"::Employee);
                        GenJnlLine."Account No." := Rec."Account No.";
                        GenJnlLine.Validate(GenJnlLine."Account No.");
                        GenJnlLine.Description := 'LC Utility Advance: ' + Rec."Account No." + ':' + Rec.Payee;
