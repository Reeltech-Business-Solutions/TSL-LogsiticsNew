page 50218 "Converted LC Request Card"
{
    Caption = 'Converted LC Request Card';
    DeleteAllowed = true;
    Editable = false;
    PageType = Document;
    ...
    SourceTableView = WHERE("Payment Type" = CONST(LC), "PV Created" = filter(true), Posted = filter(false));
            ...
            group(Functions)
            {
                ...
                action("Cancel Approval Re&quest")
                {
                    ...
                    var
                        ApprovalMgt: Codeunit "Approval Mgmt. ExtCal";
                    begin
                        ApprovalMgt.CheckPHeaderApprovalsWorkflowEnable(Rec);
                    end;
                }
