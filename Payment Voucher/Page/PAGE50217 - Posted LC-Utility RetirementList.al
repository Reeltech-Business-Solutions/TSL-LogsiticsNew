page 50217 "Posted LC-Utility Ret. List"
{
    Caption = 'Posted LC-Utility Retirement List';
    ...
    SourceTableView = WHERE(Posted = CONST(true), "Retirement Type" = filter(LC));
    UsageCategory = Lists;
    InsertAllowed = false;
                    ...
                    begin
                        ...
                        if ImprestDetails.Find('-') then begin
                            repeat
                                ...
                                GenJnlLine.Description := CopyStr('LC Utility Retirement ' + ImprestDetails."Account Name", 1, 50);
                                ...
                                //GenJnlLine."Bal. Account Type":=GenJnlLine."Bal. Account Type"::Employee;
                                //GenJnlLine."Bal. Account No.":=ImprestDetails."Advance Holder";
                                GenJnlLine.Description := CopyStr('LC Utility Surrendered ' + ImprestDetails."Account Name", 1, 50);
                                //GenJnlLine.VALIDATE(GenJnlLine."Bal. Account No.");
                                GenJnlLine."Currency Code" := Rec."Currency Code";
                                GenJnlLine.Validate("Currency Code");
                                //Take care of Currency Factor
