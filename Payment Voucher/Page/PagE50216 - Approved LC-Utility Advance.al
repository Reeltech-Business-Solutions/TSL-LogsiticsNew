page 50216 "Approved LC-UtilityAdv.Request"
{
    Caption = 'Approved LC-Utility Advance';
    DeleteAllowed = false;
    PageType = Document;
    //Editable = false;
    InsertAllowed = false;
    ...
    SourceTableView = WHERE(Status = filter(Approved), "Type of Advance" = filter(LC));
            ...
            group(Approval)
            {
                ...
                action(PostAdvance)
                {
                    ...
                    begin
                        ...
                        GenJnlLine.Description := 'LC Advance: ' + Rec."Account No." + ':' + Rec.Payee;
