page 50212 "LC-Utility Retirement Card"
{
    Caption = 'LC-Utility Retirement Card';
    SourceTable = "Staff Advanc Surrender Header";
    PageType = Document;
    PromotedActionCategories = 'New,Process,Report,Approvals,Attachments';
    SourceTableView = WHERE("Retirement Type" = filter(LC));
                    ...
                    begin
                        ...
                        if ImprestDetails.Find('-') then begin
                            repeat
                                ...
                                GenJnlLine.Description := COPYSTR('LC Advance Retirement ' + ImprestDetails."Account Name", 1, 50);
                                ...
                                //GenJnlLine."Bal. Account Type":=GenJnlLine."Bal. Account Type"::Employee;
                                //GenJnlLine."Bal. Account No.":=ImprestDetails."Advance Holder";
                                GenJnlLine.Description := COPYSTR('Advance Retirement ' + ImprestDetails."Account Name", 1, 50);
                                //GenJnlLine.VALIDATE(GenJnlLine."Bal. Account No.");
                                GenJnlLine."Currency Code" := Rec."Currency Code";
                                GenJnlLine.VALIDATE("Currency Code");
                                //Take care of Currency Factor
                            ...
                            IF Rec.Difference <> 0 THEN begin                               //InsertBank;
                                ...
                                GenJnlLine.Validate(GenJnlLine.Amount);
                                GenJnlLine.Description := 'LC Advance' + Rec."No." + ' Retired by staff' + Rec."Account No.";
                                GenJnlLine."Currency Code" := Rec."Currency Code";
                                GenJnlLine.Validate("Currency Code");
                                //Take care of Currency Factor
                                GenJnlLine."Currency Factor" := Rec."Currency Factor";
    ...
    begin
        ...
        Rec."Retirement Type" := Rec."Retirement Type"::LC;
    ...
    begin
        ...
        if Rec."Actual Spent" = 0 then
            GenJnlLine.Amount := Rec.Amount;
        GenJnlLine.Validate(GenJnlLine.Amount);
        GenJnlLine.Description := 'LC Utility Advance' + Rec."No." + ' Retired by' + Rec."Account No.";
        GenJnlLine."Currency Code" := Rec."Currency Code";
        GenJnlLine.Validate("Currency Code");
        //Take care of Currency Factor
        GenJnlLine."Currency Factor" := Rec."Currency Factor";
