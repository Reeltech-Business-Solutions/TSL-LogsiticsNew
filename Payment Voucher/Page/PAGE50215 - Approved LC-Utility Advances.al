page 50215 "Approved LC-Utility Advances"
{
    ApplicationArea = All;
    Caption = 'Approved LC-Utility Advances';
    PageType = List;
    CardPageID = "Approved LC-UtilityAdv.Request";
    DeleteAllowed = false;
    Editable = false;
    PromotedActionCategories = 'New,Process,Reports,Approval,Budgetary Control,Cancellation,Category7_caption,Category8_caption,Category9_caption,Category10_caption';
    SourceTable = "Staff Advance Header";
    SourceTableView = WHERE(Status = Const(Approved), Posted = CONST(false), "Type of Advance" = filter(LC));
    UsageCategory = Lists;
