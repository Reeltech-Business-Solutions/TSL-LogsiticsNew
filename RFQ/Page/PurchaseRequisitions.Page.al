page 50168 "Purchase Requisitions"
{
    ApplicationArea = All;
    // UsageCategory = Lists;
    ...
    SourceTableView = WHERE("Document Type" = CONST(Quote), "Purchase Type" = CONST("Local Requisition"), Status = filter(Open | "Pending Approval"));
