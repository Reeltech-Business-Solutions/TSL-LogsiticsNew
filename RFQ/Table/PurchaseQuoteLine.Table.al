table 50031 "Purchase Quote Line"
{
    Caption = 'Purchase Quote Line';
    LookupPageID = "RFQ Subform"; //39004371;
    PasteIsValid = false;
    ...
    fields
    {
        ...
        field(46; "Shortcut Dimension 6 Code"; Code[20])
        {
            CaptionClass = '1,2,6';
        ...
        field(47; "Shortcut Dimension 7 Code"; Code[20])
        {
            CaptionClass = '1,2,7';
        ...
        field(48; "Shortcut Dimension 8 Code"; Code[20])
        {
            CaptionClass = '1,2,8';
            ...
            trigger OnValidate()
            begin
                //   ValidateShortcutDimCode(7, "Shortcut Dimension 8 Code");
            end;
        }
        ...
        {
            //to   TableRelation = "Receipts and Payment Types";
            trigger OnValidate()
            var
            //to       ExpenseList: record "Receipts and Payment Types";
            begin
                //to   // ExpenseList.SETCURRENTKEY(ExpenseList.Code);
