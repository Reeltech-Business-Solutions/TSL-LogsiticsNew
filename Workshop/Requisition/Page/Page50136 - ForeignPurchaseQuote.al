page 50136 "Foreign Purchase Quote"
{
    Caption = 'Foreign Purchase Quote';
    PageType = Document;
    SourceTable = "Purchase Header";
    PromotedActionCategories = 'New,Process,Report,Approve,Request Approval,Print/Send,Quote,Release,Navigate';
    RefreshOnActivate = true;

    SourceTableView = WHERE("Document Type" = FILTER(Quote), "Purchase Type" = filter(Foreign));
    ...
    begin
        ...
        //RBS
        Rec."Purchase Type" := Rec."Purchase Type"::Foreign;
