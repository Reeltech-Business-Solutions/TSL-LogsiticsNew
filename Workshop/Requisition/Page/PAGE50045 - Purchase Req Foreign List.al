page 50045 "Purchase Foreign Req List"
{
    AdditionalSearchTerms = 'rfq,request for quote,purchase requisition';
    ApplicationArea = Suite;
    Caption = 'Foreign Purchase Requisition List';
    CardPageID = "Purchase Foreign Req";
    ...
    SourceTableView = WHERE("Document Type" = CONST(Quote), "Purchase Type" = filter("Foreign Requisition"), Status = filter(Open | "Pending Approval" | "Pending Prepayment"));
    // UsageCategory = Lists;
