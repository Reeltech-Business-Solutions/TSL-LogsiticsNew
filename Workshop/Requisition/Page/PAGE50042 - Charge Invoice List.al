page 50042 "Charge Invoices"
{

    ApplicationArea = Basic, Suite;
    Caption = 'Charge Invoice List';
    //CardPageID = "Purchase Invoice";
    CardPageID = "Charge Invoice";
    ...
    SourceTableView = WHERE("Document Type" = CONST(Invoice), "Purchase Type" = filter("Import Charge"));
            ...
            group(Display)
            {
                ...
                action(ReportFactBoxVisibility)
                {
                    ...
                    begin
                        ...
                        // CurrPage."Power BI Report FactBox".PAGE.SetFactBoxVisibility(PowerBIVisible); tolu
                    end;
                }
            }
        }
    ...
    begin
        ...
        //  CurrPage."Power BI Report FactBox".PAGE.SetCurrentListSelection(Rec."No.", false, PowerBIVisible); tolu
    end;

    trigger OnInit()
    begin
        // CurrPage."Power BI Report FactBox".PAGE.InitFactBox(CurrPage.ObjectId(false), CurrPage.Caption, PowerBIVisible); tolu
    end;
