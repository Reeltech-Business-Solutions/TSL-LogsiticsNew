page 50046 "Purchase Local Req"
{
    Caption = 'Purchase Req';
    PageType = Document;
    PromotedActionCategories = 'New,Process,Report,Approve,Request Approval,Print/Send,Navigate,Release';
        ...
        area(content)
        {
            group(General)
            {
                ...
                field("Shortcut Dimension 3 Code"; Rec."Shortcut Dimension 3 Code")
                {
                    ...
                    trigger OnValidate()
                    begin
                        ShortcutDimension3CodeOnAfterV;
                    end;
                }
                ...
                field("Shortcut Dimension 5 Code"; Rec."Shortcut Dimension 5 Code")
                {
                    ...
                    trigger OnValidate()
                    begin
                        ShortcutDimension5CodeOnAfterV;
                    end;
                ...
                field("Shortcut Dimension 6 Code"; Rec."Shortcut Dimension 6 Code")
                {
                    ...
                    trigger OnValidate()
                    begin
                        ShortcutDimension6CodeOnAfterV;
                    end;
                }
                field("Shortcut Dimension 7 Code"; Rec."Shortcut Dimension 7 Code")
                {
                    ...
                    trigger OnValidate()
                    begin
                        ShortcutDimension7CodeOnAfterV;
                    end;
                }
                field("Shortcut Dimension 8 Code"; Rec."Shortcut Dimension 8 Code")
                {
                    ...
                    trigger OnValidate()
                    begin
                        ShortcutDimension8CodeOnAfterV;
                    end;
                }
                ...
                field("Material Req. No."; Rec."Material Req. No.")
                {
                    ...
                    var
                        ...
                        MatReqPage: Page "Job Material Request List";
                    begin
                        MatReqHeader.Reset();
                        MatReqHeader.SetRange(MatReqHeader."No.", Rec."Material Req. No.");
                        if MatReqHeader.findfirst() then begin
                            MatReqPage.setTableView(MatReqHeader);
                            MatReqPage.Run();
                        end;
            ...
            group("Request Approval")
            {
                ...
                action(SendApprovalRequest)
                {
                    ...
                    begin
                        ...
                        if GeneSetUp.PurchaseBudget then
 ...
 */
    ...
    local procedure ShortcutDimension3CodeOnAfterV()
    begin
        CurrPage.Update;
    end;

    local procedure ShortcutDimension4CodeOnAfterV()
    begin
        CurrPage.Update;
    end;

    local procedure ShortcutDimension5CodeOnAfterV()
    begin
        CurrPage.Update;
    end;

    local procedure ShortcutDimension6CodeOnAfterV()
    begin
        CurrPage.Update;
    end;

    local procedure ShortcutDimension7CodeOnAfterV()
    begin
        CurrPage.Update;
    end;

    local procedure ShortcutDimension8CodeOnAfterV()
    begin
        CurrPage.Update;
    end;
