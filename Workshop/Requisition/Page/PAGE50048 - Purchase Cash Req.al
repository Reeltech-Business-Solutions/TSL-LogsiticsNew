page 50048 "Purchase Cash Req"
{
    Caption = 'Purchase Cash Req';
    PageType = Document;
        ...
        area(processing)
        {
            ...
            group("Request Approval")
            {
                ...
                action(SendApprovalRequest)
                {
                    ...
                    var
                        ApprovalsMgmt: Codeunit "Approvals Mgmt.";
                        BudgetCheck: Codeunit "Budget Approval";
                    begin
                        BudgetCheck.ActualBudgetMothYear(Rec);
    ...
    begin
        ...
        //"Vendor Type" := "Vendor Type"::Cash;
        Rec."Purchase Type" := Rec."Purchase Type"::Cash;

        CalculateCurrentShippingAndPayToOption;

        Rec."Purchase Type" := "Purchase Type"::Cash;
        If (Rec."Purchase Type" = Rec."Purchase Type"::Cash) THEN begin
        ...
        //PurchPay.Get;
        //"PWN_Vendor No" := 'INT0001';
        Rec."Buy-from Vendor No." := 'INT0001';
        //VendorNoFilter := 'INT0001';
