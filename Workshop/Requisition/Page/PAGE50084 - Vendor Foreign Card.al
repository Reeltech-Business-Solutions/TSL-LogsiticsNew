page 50084 "Vendor Foreign Card"
{
    Caption = 'Vendor Foreign Card';
    PageType = Card;
        ...
        area(content)
        {
            group(General)
            {
                ...
                field("Vendor Type"; Rec."Vendor Type")
                {
                    ...
                    ToolTip = 'Specifies an additional part of the category of vendor.';
                    Visible = false;
                }
                field(Name; Rec.Name)
                {
    ...
    begin
        //added to to take care of vendor type for numbering
        Rec."Vendor Type" := Rec."Vendor Type"::Foreign;
        Rec.Validate("Vendor Type");
