page 50047 "Purchase Foreign Req"
{
    Caption = 'Foreign Purch. Requisition';
    PageType = Document;
    PromotedActionCategories = 'New,Process,Report,Approve,Request Approval,Print/Send,Quote,Release,Navigate';
    RefreshOnActivate = true;
    SourceTable = "Purchase Header";
    SourceTableView = WHERE("Document Type" = FILTER(Quote), "Purchase Type" = filter("Foreign Requisition"));
    ...
    var
        ...
        DocNo: Code[20];
    begin
        Rec."Purchase Type" := Rec."Purchase Type"::"Foreign Requisition";
