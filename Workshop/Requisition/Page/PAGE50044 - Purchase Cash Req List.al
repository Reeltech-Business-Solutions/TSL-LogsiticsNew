page 50044 "Purchase Cash Req List"
{
    AdditionalSearchTerms = 'rfq,request for quote,purchase requisition';
    ApplicationArea = Suite;
    Caption = 'Purchase Cash Req List';
    CardPageID = "Purchase Cash Req";
    ...
    SourceTableView = WHERE("Document Type" = CONST(Quote), "Purchase Type" = filter(Cash));
    UsageCategory = Lists;
