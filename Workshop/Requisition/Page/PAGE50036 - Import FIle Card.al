page 50036 "Import File Card"
{
    ...
    layout
    {
        ...
        area(factboxes)
        {
            ...
            // {
            //     ApplicationArea = Basic, Suite;
            //     SubPageLink = "Source Type" = filter(Vendor),
            //                   "Source No." = FIELD("No.");
    ...
    begin
        //added to take care of vendor type for numbering
        Rec."Vendor Type" := Rec."Vendor Type"::"Import File";
