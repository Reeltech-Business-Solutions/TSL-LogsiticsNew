page 50133 "Local Purchase Quote List"
{
    ...
    SourceTableView = WHERE("Document Type" = CONST(Quote), "Purchase Type" = filter(Local));
    UsageCategory = Lists;
