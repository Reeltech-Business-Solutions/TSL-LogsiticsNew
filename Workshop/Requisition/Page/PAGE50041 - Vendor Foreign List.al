page 50041 " Vendor Foreign List"
{
    ApplicationArea = Basic, Suite;
    Caption = 'Vendor Foreign List';
    CardPageID = "Vendor Foreign Card";
    Editable = false;
    PageType = List;
    PromotedActionCategories = 'New,Process,Report,New Document,Vendor,Navigate';
    QueryCategory = 'Vendor List';
    RefreshOnActivate = true;
    SourceTableView = WHERE("Vendor Type" = filter(Foreign));
    SourceTable = Vendor;
                ...
                group(Dimensions)
                {
                    ...
                    action(DimensionsMultiple)
                    {
                        ...
                        begin
                            ...
                            DefaultDimMultiple.SetMultiRecord(Vend, Rec.FieldNo(Rec."No."));
