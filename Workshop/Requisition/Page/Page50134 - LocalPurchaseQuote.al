page 50134 "Local Purch. Quote"
{
    ...
    ApplicationArea = All;
    SourceTableView = WHERE("Document Type" = FILTER(Quote), "Purchase Type" = filter(Local));
                ...
                action(MakeOrder)
                {
                    ...
                    begin
                        if ApprovalsMgmt.PrePostApprovalCheckPurch(Rec) then
                            CODEUNIT.Run(CODEUNIT::"PurchQuoteToOrder(Yes/No)", Rec);
                    end;
                }
            }
        }
    ...
    begin
        ...
        //RBS
        Rec."Purchase Type" := Rec."Purchase Type"::Local;
