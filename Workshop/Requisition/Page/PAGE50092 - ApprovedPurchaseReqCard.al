page 50092 "Purchase Local Req Card"
{
    ...
    AdditionalSearchTerms = 'Approved Purchase Requisition';
    SourceTableView = WHERE("Document Type" = CONST(Quote), "Purchase Type" = filter("Local Requisition"), "Purchase Type" = filter("Foreign Requisition"));
    ...
    layout
    {
        area(content)
        {
            ...
            part(PurchLines; "Purchase Req Subform-Approved")
            {
                ApplicationArea = Suite;
        ...
        area(processing)
        {
            ...
            group("Request Approval")
            {
                ...
                action(SendApprovalRequest)
                {
                    ...
                    begin
                        BudgetCheck.ActualBudgetMothYearPurchase(Rec);
    ...
    begin
        ...
        //PurchPay.Get;
        Rec."PWN_Vendor No" := 'INT0001';
        Rec.VendorNoFilter := 'INT0001';

        Rec.Validate("PWN_Vendor No");
        ...
        //CalculateCurrentShippingAndPayToOption;
        //PurchPay.Get("Buy-from Vendor No.");
        //PurchPay.SetRange("Vendor Requisition No", "Buy-from Vendor No.");
        //Message('%1', PurchPay."Vendor Requisition No");
        //Validate("Buy-from Vendor No.", PurchPay."Vendor Requisition No");
