codeunit 50022 "Purch.-Quote to Order RBS"
{
    ...
    begin
        ...
        //
        if PurchHeader."Purchase Type" = "Purchase Type"::Local then
        ...
        if PurchQuoteLine.FindSet then
            repeat
                ...
                if not IsHandled then begin
                    ...
                    //------>> Fola10182023 stamping order no RFQ Line
                    // RFQLine.Reset();
                    // RFQLine.SetFilter("Document No.");
                    //------>> Fola10182023 stamping order no RFQ Line
