page 80009 "Service App Schedules External"
{
    Caption = 'Service App Schedules External List';
    /* CardPageID = "Service App Schedule";
    DataCaptionFields = "Service Item","Service Code (KM)";
    PageType = List;
    SourceTable = Table50070;
    SourceTableView = SORTING(Service Item,Service Code (KM)) WHERE(Buisness Type=FILTER(EXTERNAL), Serviced=FILTER(No)); */
