page 80058 "Job List - Returned Jobs Optn."
{
    Caption = 'Job List';
    CardPageID = "Job Card - Returned Job Opn";
    Editable = true;
    PageType = List;
    SourceTable = Job;
    //SourceTableView = WHERE("Job Type Code" = FILTER("LEASE OPERATION"), Status = FILTER(<> Completed));
